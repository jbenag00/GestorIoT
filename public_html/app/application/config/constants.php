...
defined('GET_DATA_PASSWORD') OR define('GET_DATA_PASSWORD', 'javier00');
//esta es la pass que enviará tu dispositivo para poder insertar datos en la tabla data.
defined('INSERT_DATA_PASSWORD') OR define('INSERT_DATA_PASSWORD', 'javier00');

//credenciales MQTT que obtendras del nodo creado en IoTicos.org
defined('MQTT_USER') OR define('MQTT_USER', 'nJFLMuuqN2LD214');
defined('MQTT_PASSWORD') OR define('MQTT_PASSWORD', 'KUYT6eKlkIlwQPk');
defined('ROOT_TOPIC') OR define('ROOT_TOPIC', 'J1uTuznTuD2oeEl');
